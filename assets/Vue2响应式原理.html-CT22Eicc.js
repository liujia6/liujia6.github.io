import{_ as n,c as s,o as a,a as e}from"./app-CVfBBX0w.js";const l={},p=e(`<h1 id="vue-响应式原理" tabindex="-1"><a class="header-anchor" href="#vue-响应式原理"><span>Vue 响应式原理</span></a></h1><p>首先试想一下以下代码中点击$(&#39;#text&#39;)元素会发生什么呢？会触发 test 方法吗</p><div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre class="language-vue"><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span></span>
